...
export default function Disease() {
  ...
  const handleSendData = async () => {
    ...
    try {
      const response = await fetch("https://agritechbackend-c2cpd4gwbvg4cha7.canadacentral-01.azurewebsites.net/disease_ai", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="relative p-6">
      ...
      <h1 className="text-3xl font-bold mb-6">Disease Analysis</h1>
